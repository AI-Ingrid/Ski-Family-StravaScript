...
def commit_and_push_changes(abs_path_repo):
    ...
    path_to_avg_distance_plot = os.path.join(abs_path_repo, 'data/nordic_ski_avg_distance.png')
    ...
    try:
        ...
        # Add changes to git
        subprocess.run(["git", "add", path_distance_plot, path_elevation_plot, path_to_pie_plot, path_to_avg_distance_plot, path_to_readme, path_to_last_updated], check=True)
